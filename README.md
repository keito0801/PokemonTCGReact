##PokemonTCGViewer
#https://dazzling-fermi-4e6522.netlify.app/


#Keith Gonzalez
This site is an interatcive Pokemon TCG viewer. A simple search engine is offered allowing the user to search for any pokemon by name and see all available trading cards coresponding to that pokemon. A selection menu is also available to allow for a more focused search on a particualr series of pokemon cards. This site was made using React. After searching for a name the site will render a set of pokemon cards displaying its name, type, series, and a small description.
